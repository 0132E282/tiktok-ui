...
const LIST_FOOTER = [
    ...
    ["TikTok","for Good","Quảng cáo","Developers","Transparency ","TikTok"," RewardsTikTok","BrowseTikTok","Embeds"],
            ...
            <div className={cx('sidebar-tag')} >
              ...
              <div className={cx('container')}>
                {LIST_TAG_DISCOVER.map((item,index)=>{
                        return <div key={index} className={cx("tag-discover")}>
              ...
              <div className={cx("footer")}>
                  {LIST_FOOTER.map( (listMenu,index)=>{
                    return <ul key={index} className={cx("menu")}>
                      {listMenu.map((item,index)=>{
                        return <li key={index} className={cx("list-menu-item")}>{item}</li>
                      })}
                    </ul>
                  })}
