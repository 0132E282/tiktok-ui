...
function Video({id, video_rul }) {
    ...
    const handleUpdateSeekBar = useCallback((e)=>{
   ...
   const timeVideo =  (time)=> {
    ...
    return (<div className={cx("video-wrapper")} ref={videoRef1}>
      ...
      <div className={cx("video__container--controller")}>
         <div className={cx("controller__button")}>
            <div className={cx("btn-video")}>
              <Button className={cx("btn__play-pause")} icon={ isPlayVideo ? <IconPlay/> :<IconPause/> }/>
            </div>
