export const IconSearch = ({ width = "3.2rem", height = "3.2rem", color = "currentColor", className }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconLoading = ({ className, width = '1rem', height = '1rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconClear = ({ className, width = '1rem', height = '1rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconContainer = ({ className, width = '1rem', height = '1rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconListMenu = ({ className, width = '2rem', height = '2rem', color = "currentColor" }) => {
...
export const IconAdd = ({ className, width = '2rem', height = '2rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconLanguages = ({ className, width = '2rem', height = '2rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconSettings = ({ className, width = '2rem', height = '2rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconShortcuts = ({ className, width = '2rem', height = '2rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconBack = ({ className, width = '2rem', height = '2rem', color = "currentColor" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
