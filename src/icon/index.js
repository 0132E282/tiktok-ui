export const IconSearch = ({ width = "3.2rem", height = "3.2rem", color = "rgba(22, 24, 35, 0.34)", className }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconLoading = ({ className, width = '1rem', height = '1rem', color = "rgba(22, 24, 35, 0.34)" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
...
export const IconClear = ({ className, width = '1rem', height = '1rem', color = "rgba(22, 24, 35, 0.34)" }) => {
    return <svg
        className={className}
        width={width}
        height={height}
